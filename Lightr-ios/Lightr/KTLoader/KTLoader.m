...
@property (nonatomic, strong) UIView *loaderBG;
...
- (void) initLoader
{
    ...
    _loader.backgroundColor = [UIColor colorWithWhite:0.0f alpha:0.6f];
    _loader.hidden = TRUE;
    _loader.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
    
    _loaderBG = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 140, 140)];
    _loaderBG.backgroundColor = [UIColor colorWithWhite:0.0f alpha:0.8f];
    _loaderBG.layer.cornerRadius = 10.0f;
    _loaderBG.layer.shadowColor = [UIColor blackColor].CGColor;
    _loaderBG.center = CGPointMake(_loader.frame.size.width/2, _loader.frame.size.height/2);
    _loaderBG.autoresizingMask = UIViewAutoresizingFlexibleRightMargin | UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleTopMargin | UIViewAutoresizingFlexibleBottomMargin;
    [_loaderBG normalizeView];
    [_loader addSubview:_loaderBG];
    
    _loaderLabel = [[UILabel alloc] initWithFrame:CGRectMake(4, _loaderBG.bounds.size.height-50, _loaderBG.bounds.size.width-8, 50)];
    ...
    [_loaderBG addSubview:_loaderLabel];
    [_loaderLabel normalizeView];
    
    _spinner = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleWhiteLarge];
    _spinner.center = CGPointMake(_loaderBG.bounds.size.width/2, (_loaderBG.bounds.size.height)/3);
    [_loaderBG addSubview:_spinner];
    ...
    [_loaderBG addSubview:_indicator];
    ...
    [_loaderBG addSubview:_progressIndicator];
    ...
    andHideInterval:(KTLoaderIndicatorDuration)hideInterval
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        CGFloat rotate = ([UIDevice currentDevice].orientation == UIDeviceOrientationLandscapeLeft) ? M_PI/2 : -1*M_PI/2;
        [KTLoader sharedInstance].loaderBG.transform = CGAffineTransformMakeRotation(rotate);
